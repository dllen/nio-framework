...
/**
 * Test interrupt and async close semantics of InterruptibleChannel objects. This is test code to demonstrate bugs in the 1.4.0 implementation. Use of /dev/tty with FileChannel will probably not work
 * in future releases.
 *
 * @author Ron Hitchens (ron@ronsoft.com) $Id: ChannelClose.java,v 1.3 2002/05/20 07:24:29 ron Exp $
 */
