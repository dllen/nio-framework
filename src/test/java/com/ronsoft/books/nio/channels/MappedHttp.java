...
/**
 * Dummy HTTP server using MappedByteBuffers. Given a filename on the command line, pretend to be a web server and generate an HTTP response containing the file content preceded by appropriate
