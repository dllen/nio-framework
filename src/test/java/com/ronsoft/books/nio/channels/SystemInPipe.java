...
/**
 * Class which encapsulates System.in as a selectable channel. Instantiate this class, call start() on it to run the background draining thread, then call getStdinChannel() to get a SelectableChannel
 * object which can be used with a Selector object.
 *
 * @author Ron Hitchens (ron@ronsoft.com) created: Jan 2003
 */
