...
/**
 * Test locking with FileChannel. Run one copy of this code with arguments "-w /tmp/locktest.dat" and one or more copies with "-r /tmp/locktest.dat" to see the interactions of exclusive and shared
 * locks.  Note how too many readers can starve out the writer. Note: The filename you provide will be overwritten.  Substitute an appropriate temp filename for your favorite operating system.
 * <p>
 * Created April, 2002
 *
