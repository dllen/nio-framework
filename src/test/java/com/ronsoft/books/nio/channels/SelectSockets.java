...
/**
 * Simple echo-back server which listens for incoming stream connections and echoes back whatever it reads.  A single Selector object is used to listen to the server socket (to accept new connections)
 * and all the active socket channels.
 *
...
public class SelectSockets {
     ...
     *
     * @param key A SelectionKey object associated with a channel determined by the selector to be ready for reading.  If the channel returns an EOF condition, it is closed here, which automatically
