...
/**
 * Provide RFC 868 time service (http://www.ietf.org/rfc/rfc0868.txt). This code implements an RFC 868 listener to provide time service.  The defined port for time service is 37.  On most unix
 * systems, root privilege is required to bind to ports below 1024.  You can either run this code as root or provide another port number on the command line.  Use "-p port#" with TimeClient if you
