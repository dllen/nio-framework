...
/**
 * Test behavior of FileChannel on stream devices. Per MR at Sun, this is officially not supported. FileChannel should not work with non-files, it's a "hole in the spec" and will be closed in the
 * future.
 *
 * @author Ron Hitchens
