...
/**
 * Demonstrate behavior of splitting strings.  The XML output created here can be styled into HTML or some other useful form. See poodle.xsl.
 * <p>
 * Created: April, 2002
 *
...
public class Poodle {
    ...
    /**
     * Output a simple XML document with the results of applying the list of regex patterns to the input with each of the limit values provided.  I should probably use the JAX APIs to do this, but I
    ...
    /**
     * If command line args were given, compile all args after the first as a Pattern.  Return an array of Pattern objects.
     */
