...
/**
 * Extract information about a class.  This class was used to generate the quick reference for the NIO book for O'Reilly.  It's kind of ugly and there are a lot of hacks in here.  The most obvious one
 * is the wrapping of <emphasis> tags around class and member names in the toString() output. With a little work this could be made into a generic class introspector, but it currently has some warts
 * on it.
 * <p>
 * Created May 2002
 *
