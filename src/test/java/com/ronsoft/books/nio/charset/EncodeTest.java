...
/**
 * Charset encoding test.  Run the same input string, which contains some non-ascii characters, through several Charset encoders and dump out the hex values of the resulting byte sequences.
 *
...
public class EncodeTest {
    ...
    /**
     * For a given Charset and input string, encode the chars and print out the resulting byte encoding in a readable form.
     */
