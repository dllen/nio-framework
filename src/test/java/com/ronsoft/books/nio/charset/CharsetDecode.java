...
/**
 * Test charset decoding Java New I/O book. Created and tested: Dec, 2001
 *
...
public class CharsetDecode {
    ...
    /**
     * Test charset decoding in the general case, detecting and handling buffer under/overflow and flushing the decoder state at end of input. This code reads from stdin and decodes the ASCII-encoded
     * byte stream to chars.  The decoded chars are written to stdout.  This is effectively a 'cat' for input ascii files, but another charset encoding could be used by simply specifying it on the
     * command line.
     */
